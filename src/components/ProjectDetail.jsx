...
const ProjectDetails = () => {
  ...
  const handleGithubClick = useCallback((githubLink) => {
    if (githubLink === 'Private') {
      Swal.fire({
        ...
        text: 'Maraf, source code untuk proyek ini bersifat privat.',
  ...
  const enhancedProject = useMemo(() => {
    ...
    return {
      ...
      Github: project.Github || 'https://github.com/onsben19',
      // Handle both array and JSONB formats for backward compatibility
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  ...
                  onClick={(e) => !handleGithubClick(enhancedProject.Github) && e.preventDefault()}
                >
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                {enhancedProject.TechStack.length > 0 ? (
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                ...
                {enhancedProject.Features.length > 0 ? (
              ...
              <ImageGallery 
                ...
                projectTitle={enhancedProject.Title}
              />

              {/* Demo Video */}
              <VideoPlayer 
                videoUrl={enhancedProject.video} 
                projectTitle={enhancedProject.Title}
              />
            </div>
          </div>
