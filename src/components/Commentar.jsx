    ...
    return (
        <div 
            className={`px-4 pt-4 pb-2 rounded-xl border transition-all group hover:shadow-lg hover:-translate-y-0.5 ${
                isPinned 
                    ? 'bg-gradient-to-r from-blue-500/10 to-blue-500/10 border-blue-500/30 hover:bg-gradient-to-r hover:from-blue-500/15 hover:to-blue-500/15' 
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-[#3b82f6] to-[#1d4ed8] rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
