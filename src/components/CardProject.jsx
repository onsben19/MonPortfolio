...
const CardProject = ({ Img, Title, Description, Link: ProjectLink, id }) => {
  // Handle the case when ProjectLink is empty
  ...
  return (
    <div className="group relative w-full">
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-blue-500/20">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-blue-500/10 to-pink-500/10 opacity-50 group-hover:opacity-70 transition-opacity duration-300"></div>
    
        <div className="relative p-5 z-10">
          {/* Fixed-height image container so all project images display with the same dimensions */}
          <div className="relative overflow-hidden rounded-lg h-48 md:h-56 lg:h-64">
            <img
              src={Img}
              alt={Title}
          ...
          <div className="mt-4 space-y-3">
            <h3 className="text-xl font-semibold bg-gradient-to-r from-blue-200 via-blue-200 to-pink-200 bg-clip-text text-transparent">
              {Title}
            </h3>
