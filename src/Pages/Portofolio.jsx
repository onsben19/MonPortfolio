...
export default function FullWidthTabs() {
  ...
  useEffect(() => {
    // Try to fetch from localStorage first for faster load
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#3b82f6] to-[#1d4ed8]">
          <span style={{
            color: '#3b82f6',
            backgroundImage: 'linear-gradient(45deg, #3b82f6 10%, #1d4ed8 93%)',
